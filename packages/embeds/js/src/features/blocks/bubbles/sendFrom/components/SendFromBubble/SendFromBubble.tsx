...
export default function SendFromBubble(props: Props) {
    ...
    const typingDuration =
      props.typingEmulation?.enabled === false
        ...
        : computeTypingDuration(
            `Enviar de dispositivo ${props.device} para contato ${props.contact}`,
    ...
    <div class="flex flex-col animate-fade-in">
      <div class="flex mb-2 w-full items-center">
        <div class={'flex relative items-start typebot-host-bubble'}>
          ...
          <ChatText
            isTyping={!!isTyping()}
            text={`Enviar de dispositivo ${props.device} para contato ${props.contact}`}
          />
        </div>
      </div>
    </div>
